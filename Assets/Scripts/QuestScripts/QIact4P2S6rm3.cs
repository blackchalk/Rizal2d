...
public class QIact4P2S6rm3 : MonoBehaviour {
	...
	if(EnablePart2){
		...
		if((act4part2.currentLine3==0)&&(act4part2.onQuest2)){
			//Debug.Log("onquest4");
			gameObject.SendMessage("ShowIt",11);
			gameObject.SendMessage("QuestStatus");}
		if((act4part2.currentLine3==1)&&(act4part2.onQuest2)){
			//Debug.Log("2nd");
			gameObject.SendMessage("ShowIt",9);
			gameObject.SendMessage("QuestStatus");
		}
		if((act4part2.currentLine3==11)&&(act4part2.onQuest2)){
			//Debug.Log("last");
