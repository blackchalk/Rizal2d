...
public class MPJoyStick : MonoBehaviour
{
	...
	public float x, y;// Default position / extents of the joystick graphic
	...
	void Disable() {
		...
		//gameObject.active = false;//edited by raygon 3feb948 due to player moves automatically w/o inputs
